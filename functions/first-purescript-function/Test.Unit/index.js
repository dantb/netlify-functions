    ...
    var go = function (v) {
        if (v instanceof TestGroup) {
            return Data_Functor.voidLeft(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Class.modify(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))((function () {
                var $169 = Data_HeytingAlgebra.disj(Data_Tuple.heytingAlgebraTuple(haytingAlgebraOnly)(haytingAlgebraOnly))(hasOnly(v.value0.value1));
                var $170 = Data_HeytingAlgebra.disj(Data_Tuple.heytingAlgebraTuple(haytingAlgebraOnly)(haytingAlgebraOnly))(new Data_Tuple.Tuple(v.value2, Data_HeytingAlgebra.ff(haytingAlgebraOnly)));
                return function ($171) {
                    return $169($170($171));
                };
            })()))(v.value3);
...
var failure = (function () {
    var $172 = Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff);
    return function ($173) {
        return $172(Effect_Exception.error($173));
    };
})();
var describe = suite;
...
var collectTests = (function () {
    var $174 = Data_Functor.map(Effect_Aff.functorAff)(Data_List.reverse);
    var $175 = walkSuite(function (v) {
        return function (v1) {
