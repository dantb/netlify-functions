...
var ifAccepts = function (type_) {
    return function (act) {
        return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Control_Monad.liftM1(Node_Express_Handler.monadHandlerM)(Data_Maybe.maybe(false)(Data_Function["const"](true)))(accepts(type_)))(function (v) {
