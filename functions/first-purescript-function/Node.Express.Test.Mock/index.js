...
var testExpress = function (testName) {
    return function (assertions) {
        return Test_Unit.test(testName)(Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)($foreign.createMockApp))(function (v) {
            return Control_Monad_Reader_Trans.runReaderT(assertions)(v);
        }));
    };
};
var setupMockApp = function (app) {
    return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (v) {
        return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Node_Express_App.apply(app)(v));
    });
};
    ...
    return function (url) {
        return function (setupRequest) {
            return function (testResponse) {
                return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (v) {
                    return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Data_Functor.map(Effect.functorEffect)(setupRequest)($foreign.createMockRequest(Data_Show.show(Node_Express_Types.showMethod)(method))(url))))(function (v1) {
                        return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))($foreign.sendMockRequest(v)(v1)))(function (v2) {
                            return testResponse(v2);
                        });
                    });
                });
            };
...
var sendError = function (method) {
    return function (url) {
        return function (error) {
            return function (testResponse) {
                return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (v) {
                    return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))($foreign.createMockRequest(Data_Show.show(Node_Express_Types.showMethod)(method))(url)))(function (v1) {
                        return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))($foreign.sendMockError(v)(v1)(error)))(function (v2) {
                            return testResponse(v2);
                        });
                    });
                });
    ...
    return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (v) {
        var reporter = function (result) {
            return function __do() {
                var v1 = Effect_Aff.launchAff(result)();
                return Data_Unit.unit;
            };
        };
        return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Node_Express_App.apply(assertion(reporter))(v));
    });
};
