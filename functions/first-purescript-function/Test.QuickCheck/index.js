...
var testableBoolean = new Testable(function (v) {
    ...
    throw new Error("Failed pattern match at Test.QuickCheck (line 163, column 1 - line 165, column 51): " + [ v.constructor.name ]);
});
...
var showResult = new Data_Show.Show(function (v) {
    ...
    throw new Error("Failed pattern match at Test.QuickCheck (line 176, column 1 - line 178, column 40): " + [ v.constructor.name ]);
});
