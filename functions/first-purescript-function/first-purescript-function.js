...
(function($PS) {
  ...
  var app = Node_Express_App.get()("/")(Node_Express_Response.send(Simple_JSON.writeJSON(Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
      return "response";
  }))(Simple_JSON.writeForeignArray(Simple_JSON.writeForeignString))(Simple_JSON.nilWriteForeignFields)()()()))({
      response: responseVal
  })));
  var main = Node_Express_App.listenHttp(app)(3000)(function (v) {
      return Effect_Console.log("Listening on " + Data_Show.show(Data_Show.showInt)(3000));
  });
