...
var genericEncodeEnum = function (dictGeneric) {
    return function (dictGenericEncodeEnum) {
        return function (opts) {
            var $38 = encodeEnum(dictGenericEncodeEnum)(opts);
            var $39 = Data_Generic_Rep.from(dictGeneric);
            return function ($40) {
                return $38($39($40));
            };
        };
...
var genericDecodeEnum = function (dictGeneric) {
    return function (dictGenericDecodeEnum) {
        return function (opts) {
            var $41 = Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(Data_Generic_Rep.to(dictGeneric));
            var $42 = decodeEnum(dictGenericDecodeEnum)(opts);
            return function ($43) {
                return $41($42($43));
            };
        };
