                        ...
                        return Data_Functor["void"](Effect_Aff.functorAff)((function () {
                            ...
                            if (v1 instanceof Data_Either.Left) {
                                return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                                    ...
                                    Test_Unit_Console.printFail(Effect_Exception.message(v1.value0))();
                                    return Test_Unit_Console.print("\x0a")();
                                });
                            };
                            throw new Error("Failed pattern match at Test.Unit.Output.Fancy (line 42, column 14 - line 54, column 21): " + [ v1.constructor.name ]);
                        })());
                    });
                });
            };
